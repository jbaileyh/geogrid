...
```{r example2, message = FALSE,results='hide',fig.keep='all'}
...
- Isolate the grid generation so that it can be a choice (it's not deterministic at the moment)
- Remove all options that aren't `hungarian`.
- Troubleshoot the merging under the method `hexagonal | hungarian`
